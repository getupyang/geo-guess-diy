    ...
    return (
      <div className="min-h-screen bg-gray-900 text-white flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4 pb-36">
          ...
          <button
            onClick={onBack}
            className="w-full text-left group relative overflow-hidden rounded-3xl active:scale-[0.98] transition-transform"
          >
            {/* Background gradient layer */}
            <div className="absolute inset-0 bg-gradient-to-br from-teal-500/25 via-cyan-500/15 to-blue-600/20" />
            <div className="absolute inset-0 border border-teal-400/30 rounded-3xl" />

            <div className="relative flex items-center gap-4 p-5">
              {/* Globe icon */}
              <div className="w-14 h-14 rounded-2xl bg-teal-500/20 flex items-center justify-center flex-shrink-0">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-teal-300">
              ...
              <div className="flex-1 min-w-0">
                <p className="font-bold text-white text-base leading-snug">还有更多有趣地点等你探索</p>
                <p className="text-xs text-teal-300/80 mt-0.5">去首页发现新挑战 →</p>
              </div>

              {/* Arrow */}
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-teal-400 flex-shrink-0 group-active:translate-x-1 transition-transform">
                <polyline points="9 18 15 12 9 6"/>
              </svg>
            </div>
          </button>
        ...
        {/* Fixed bottom: primary = go home, secondary = share */}
        <div className="fixed bottom-0 left-0 right-0 p-4 bg-gray-900/95 backdrop-blur border-t border-gray-800 space-y-2">
          <button
            onClick={onBack}
            className="w-full py-3.5 bg-teal-500 rounded-2xl font-bold text-white active:scale-95 transition-transform flex items-center justify-center gap-2"
          >
